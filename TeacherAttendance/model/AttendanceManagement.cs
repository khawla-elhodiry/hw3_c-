...
namespace TeacherAttendance.model
{
    class AttendanceManagement
    {
        ...
        public void update(
           int index ,String attandancedate, Teacher teacher,
                 Course course, Room room, string starttime,
                 string leavetime, string comment
            )
        {
            
            attendance[index].teacher = teacher;
            attendance[index].course = course;
            attendance[index].room = room;
            attendance[index].attandancedate = attandancedate;
            attendance[index].starttime = starttime;
            attendance[index].leavetime = leavetime;
            attendance[index].comment = comment;
